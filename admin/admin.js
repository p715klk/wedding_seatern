...
function saveAllToFirebase() {
    ...
    rows.forEach((row) => {
        ...
        // 如果留空代表「未安排」，儲存時自動包裝成桌號 99 丟進畫布待分配 Pool
        let targetTable = 99;
    ...
    // 🌟 直接全面覆蓋 wedding_guests 節點，保證跟排位畫布絕對同步
